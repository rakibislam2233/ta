            ...
            return (
              ...
              >
                <div className="flex items-center gap-4">
                  <div className={`w-12 h-12 rounded-full ${notification.color} flex items-center justify-center flex-shrink-0`}>
                  ...
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#9419e6] to-[#7a14c4] flex items-center justify-center flex-shrink-0">
