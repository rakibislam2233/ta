    ...
    <div className="max-w-4xl mx-auto px-6 py-12">
      <div className="bg-background border border-border rounded-2xl p-8 shadow-2xl">
        <div className="flex items-center gap-4 mb-6">
          ...
          <h1 className="text-3xl font-bold text-foreground">About Talenzy</h1>
        </div>
        ...
        <div className="space-y-6 text-foreground">
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-8">
            <div className="bg-background p-6 rounded-xl border border-border/50 hover:border-primary/50 transition-colors">
