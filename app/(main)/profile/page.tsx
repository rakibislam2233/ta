      ...
      <div className="px-4 sm:px-6 pb-6 relative">
        <div className="flex flex-col md:flex-row items-center md:items-end justify-between -mt-20 sm:-mt-24 mb-6 gap-6 md:gap-4">
          <div className="relative group mx-auto md:mx-0">
            <div className="size-32 sm:size-40 rounded-full p-1.5 bg-background">
              <div className="w-full h-full rounded-full bg-gradient-to-br from-primary to-purple-400 p-[2px]">
                <div className="w-full h-full rounded-full bg-background overflow-hidden relative">
                  <div className="w-full h-full bg-gradient-to-br from-primary/20 to-purple-500/20 flex items-center justify-center text-4xl font-bold text-foreground relative">
                    <Image
            ...
            <button className="absolute bottom-1 sm:bottom-3 right-1 sm:right-3 bg-primary hover:bg-primary-hover text-primary-foreground p-2 sm:p-2.5 rounded-full border-4 border-background shadow-lg transition-transform hover:scale-105 active:scale-95">
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-end gap-2 sm:gap-3 mb-2 text-foreground w-full md:w-auto">
            <Button className="flex-1 md:flex-none bg-primary hover:bg-primary-hover text-primary-foreground rounded-full h-10 px-6 font-bold shadow-glow transition-all hover:-translate-y-0.5">
              Edit Profile
            </Button>
            <Button
              variant="outline"
              className="flex-1 md:flex-none bg-background border-border text-foreground hover:bg-accent hover:border-primary/50 hover:text-primary rounded-full h-10 px-4 font-semibold transition-all flex items-center justify-center"
            >
            ...
            <Button
              variant="outline"
              size="icon"
              className="shrink-0 bg-background border border-border text-muted-foreground hover:text-foreground hover:border-foreground/20 rounded-full h-10 w-10 flex items-center justify-center transition-all bg-transparent"
            >
