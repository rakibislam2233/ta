...
export default function TopBar() {
  return (
    <div className="bg-[#221c26] border-b border-[#4a3c53]/30 px-6 py-4 sticky top-0 z-10">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#9419e6] to-[#7a14c4] flex items-center justify-center cursor-pointer hover:ring-2 hover:ring-[#9419e6] transition-all">
